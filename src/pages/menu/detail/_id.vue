      ...
      <div class="row">
        <div class="col-7">
          ...
          <div class="table-item-detail">
            <dl>
              <dt>Kích cỡ</dt>
              <dd class="text-start">Đường kính 60mm x Cao 60mm</dd>
              <dt>Thời gian bán hàng</dt>
              <dd class="text-start">2021/11/17 ～ 2022/2/28</dd>
              <dt>Giá</dt>
              <dd v-if="mainProduct.reduced_price === null" class="text-start">
                {{ mainProduct.price }}đ
              </dd>
              <dd v-else class="text-start">
                <del class="price-reduce"> {{ mainProduct.price }}đ </del>
